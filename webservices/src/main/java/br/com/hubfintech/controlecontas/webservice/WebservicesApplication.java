...
@ComponentScan(basePackageClasses = {TransacaoRecurso.class,RegrasTransacao.class,OperacaoService.class,Processador.class,TransacaoFactory.class, TransacaoDao.class, ContasDao.class  })
