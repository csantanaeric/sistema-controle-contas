...
INSERT INTO `conta` (`CONTA_ID`, `STATUS`, `NOME`, `CONTA_PAI_ID`, `CONTA_PAI_MATRIZ_ID`, `CONTA_PESSOA_ID`, `TP_PESSOA`, `DT_CRIACAO`) VALUES
	...
	(8, 'A', '22', 7, 7, NULL, 'J', '2017-06-16 02:00:22');
...
# Dumping data for table test.operacao: ~13 rows (approximately)
/*!40000 ALTER TABLE `operacao` DISABLE KEYS */;
INSERT INTO `operacao` (`NU_OPERACAO_ID`, `NU_TRANSACAO_ID`, `CD_STATUS_OPERACAO`, `CONTA_ORIGEM_ID`, `CONTA_DESTINO_ID`, `CD_TIPO_OPERACAO`, `DT_OPERACAO`, `VL_OPERACAO`) VALUES
	(1, 1, 'A', 2, 3, 0, '2017-06-16 02:29:43', 500.1),
	(2, 10, 'A', 2, 3, 0, '2017-06-16 02:55:36', 500.1),
	(3, 12, 'A', 0, 0, 0, '2017-06-15 21:40:19', 100),
	(4, 14, 'A', 0, 0, 0, '2017-06-15 21:49:50', 100),
	(5, 20, 'A', 0, 0, 1, '2017-06-15 22:42:05', 500.1),
	(6, 21, 'A', 0, 0, 1, '2017-06-15 22:51:04', 500.1),
	(7, 22, 'A', 0, 0, 1, '2017-06-15 22:56:38', 500.1),
	(8, 23, 'A', 0, 0, 1, '2017-06-15 23:04:39', 10000),
	(9, 24, 'A', 0, 0, 1, '2017-06-15 23:07:19', 10000),
	(10, 26, 'A', 0, 0, 1, '2017-06-15 23:08:20', 10000),
	(11, 27, 'A', 0, 0, 1, '2017-06-15 23:13:52', 50.5),
	(12, 28, 'A', 0, 0, 1, '2017-06-15 23:43:54', 10000),
	(14, 30, 'A', NULL, 1, 1, '2017-06-16 03:21:37', 10000),
	(16, 10, 'A', NULL, NULL, 2, '2017-06-16 03:27:54', 0);
...
# Dumping data for table test.saldo: ~49 rows (approximately)
...
INSERT INTO `saldo` (`SALDO_ID`, `CONTA_ID`, `SALDO`, `DH_ATUALIZACAO`) VALUES
	...
	(43, 1, 21000, '2017-06-15 23:43:54'),
	(44, 3, 30000, '2017-06-16 03:11:14'),
	(45, 3, 3000, '2017-06-16 03:11:33'),
	(46, 3, 30000, '2017-06-16 03:14:35'),
	(47, 3, 3000, '2017-06-16 03:14:37'),
	(48, 1, 21000, '2017-06-16 03:21:39'),
	(49, 3, 30000, '2017-06-16 03:25:21'),
	(50, 3, 3000, '2017-06-16 03:25:23'),
	(51, 3, 30000, '2017-06-16 03:27:58'),
	(52, 3, 3000, '2017-06-16 03:27:58');
...
CREATE TABLE IF NOT EXISTS `transacao` (
  ...
  UNIQUE KEY `CD_APORTE_UNIQUE_KEY` (`CD_APORTE`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=latin1;

# Dumping data for table test.transacao: ~29 rows (approximately)
/*!40000 ALTER TABLE `transacao` DISABLE KEYS */;
INSERT INTO `transacao` (`NU_TRANSACAO_ID`, `DT_TRANSACAO`, `CD_APORTE`) VALUES
	(1, '2017-06-14 02:03:59', 'e25fe2f1e40a74c43a09bf2937611ab4'),
	(2, '2017-06-14 02:04:14', NULL),
	(3, '2017-06-14 02:04:24', NULL),
	(4, '2017-06-14 02:04:33', NULL),
	...
	(28, '2017-06-15 23:43:54', NULL),
	(30, '2017-06-16 03:21:39', '097d642fbd17a8ebfe36bc02e9bb8d24');
