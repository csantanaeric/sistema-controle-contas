...
# Dumping data for table test.operacao: ~12 rows (approximately)
...
# Dumping data for table test.saldo: ~42 rows (approximately)
...
# Dumping data for table test.transacao: ~28 rows (approximately)
