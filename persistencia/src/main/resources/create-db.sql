...
CREATE TABLE SALDO
(
	SALDO_ID				NUMERIC(12, 0) not null primary key         GENERATED ALWAYS AS IDENTITY         (START WITH 1, INCREMENT BY 1),
	CONTA_ID				NUMERIC(12, 2),
	SALDO					NUMERIC(12, 2),
...
CREATE TABLE CONTA	
(
	CONTA_ID 				NUMERIC(12, 0) not null primary key         GENERATED ALWAYS AS IDENTITY         (START WITH 1, INCREMENT BY 1),
	NOME					VARCHAR(40),
